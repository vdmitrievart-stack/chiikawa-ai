export const I18N = {
  ru: {
    ...
    menu_run_migration: "🌊 Run Migration",
    menu_stop: "🛑 Stop",
    menu_kill: "☠️ Kill",
    menu_status: "📊 Status",
    ...
    menu_gmgn_execution: "⚙️ GMGN Execution",
...
export function buildKeyboard(t) {
  return {
    keyboard: [
      ...
      [t("menu_run_copy"), t("menu_run_migration")],
      [t("menu_stop"), t("menu_kill")],
      [t("menu_status"), t("menu_intents")],
      [t("menu_scan_ca"), t("menu_scan_market")],
      [t("menu_balance"), t("menu_wallets")],
      [t("menu_copytrade"), t("menu_budget")],
      [t("menu_gmgn_status"), t("menu_gmgn_execution")],
      [t("menu_gmgn_orders"), t("menu_leader_health")],
