...
const DEFAULT_CONFIGS = [
  { period: "5m", orderBy: "volume", direction: "desc", weight: 1.25 },
  { period: "5m", orderBy: "swaps", direction: "desc", weight: 1.15 },
  { period: "1h", orderBy: "smartmoney", direction: "desc", weight: 1.20 },
  { period: "1h", orderBy: "swaps", direction: "desc", weight: 1.10 },
  { period: "1h", orderBy: "holder_count", direction: "desc", weight: 1.00 },
  { period: "6h", orderBy: "swaps", direction: "desc", weight: 0.98 },
  { period: "6h", orderBy: "holder_count", direction: "desc", weight: 0.96 },
  { period: "24h", orderBy: "volume", direction: "desc", weight: 0.92 },
  { period: "24h", orderBy: "swaps", direction: "desc", weight: 0.90 }
];
...
export default class GMGNMarketDiscoveryService {
  constructor(options = {}) {
    ...
    this.maxPerSource = Number(options.maxPerSource || process.env.GMGN_DISCOVERY_MAX_PER_SOURCE || 70);
