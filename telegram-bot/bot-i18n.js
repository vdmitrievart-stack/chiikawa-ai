const UI = {
  ru: {
    ...
    send_team_ca: "🕵️ V2 ACTIVE. Отправьте CA токена для Team / Insider / Sniper Intel.",
  ...
  en: {
    ...
    send_team_ca: "🕵️ V2 ACTIVE. Send token CA for Team / Insider / Sniper Intel.",
