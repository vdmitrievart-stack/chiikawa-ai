...
`,
    ...
    // Лог нужен для Render logs, если что-то пойдет не так
    ...
    // Основной способ получить текст
    if (typeof data.output_text === "string" && data.output_text.trim()) {
      reply = data.output_text.trim();
    }

    // Запасной способ, если output_text пустой
    ...
    // Защита от пустых ответов и "прочерков"
